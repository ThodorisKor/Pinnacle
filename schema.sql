...
INSERT INTO `deck` (`number`, `shape`, `location`) VALUES
	...
	('4', 'diamonds', 'pile'),
	('4', 'hearts', 'pile'),
	('4', 'spades', 'kenta combination player 1'),
	('5', 'clubs', 'pile'),
	('5', 'diamonds', 'pile'),
	('5', 'hearts', 'pile'),
	('5', 'spades', 'kenta combination player 1'),
	('6', 'clubs', 'pile'),
	('6', 'diamonds', 'pile'),
	('6', 'hearts', 'player 1'),
	('6', 'spades', 'kenta combination player 1'),
	('7', 'clubs', 'player 1'),
	('7', 'diamonds', 'pile'),
	('7', 'hearts', 'pile'),
	('7', 'spades', 'kenta combination player 1'),
	('8', 'clubs', 'player 2'),
	('8', 'diamonds', 'pile'),
	('8', 'hearts', 'pile'),
	('8', 'spades', 'kenta combination player 1'),
	('9', 'clubs', 'pile'),
	('9', 'diamonds', 'player 2'),
	('9', 'hearts', 'pile'),
...
-- Dumping data for table pinnacle.game_status: ~0 rows (approximately)
INSERT INTO `game_status` (`status`, `p_turn`, `result`, `last_change`) VALUES
	('started', 'player 1', NULL, '2022-12-07 20:03:27');

-- Dumping structure for procedure pinnacle.getPileCard
DELIMITER //
CREATE PROCEDURE `getPileCard`()
BEGIN
...
INSERT INTO `players` (`username`, `id`, `token`, `last action`) VALUES
	('O mpampas sas', 1, NULL, '2022-12-07 18:43:51'),
	('teoBOI', 2, NULL, '2022-12-07 18:43:40');
